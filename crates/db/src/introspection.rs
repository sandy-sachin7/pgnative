...
use pgnative_schema::model::build::Builder;
use pgnative_schema::model::column::Column;
use pgnative_schema::model::relation::{ForeignKey, Function, PrimaryKey, Relation, UniqueKey};
use pgnative_schema::model::schema::Schema;
...
mod tests {
    use super::hydrate;
    use super::queries;
    use pgnative_schema::model::types::{Oid, RelationKind};
    ...
    fn hydrate_generated_identity() {
        ...
        assert_eq!(
            ...
            pgnative_schema::model::types::ValueSource::Generated
        );
        assert_eq!(
            rel.columns[1].value_source,
            pgnative_schema::model::types::ValueSource::Identity
        );
    }
