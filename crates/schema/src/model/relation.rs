...
use crate::model::types::{Editability, Oid, RelationId, RelationKind, SchemaId};
...
impl Relation {
    ...
    #[must_use]
    pub fn column_by_id(&self, id: crate::model::types::ColumnId) -> Option<&Column> {
...
pub struct PrimaryKey {
    ...
    pub columns: Vec<crate::model::types::ColumnId>,
...
impl UniqueKey {
    ...
    pub fn is_not_nullable(&self, relation: &Relation) -> bool {
        self.columns.iter().all(|cid| {
            relation
                .column_by_id(*cid)
                .is_some_and(|c| c.nullability == crate::model::types::Nullability::NotNull)
        })
    }
}
...
pub struct ForeignKey {
    ...
    pub referencing: Vec<crate::model::types::ColumnId>,
    /// The referenced relation.
    pub referenced_relation: RelationId,
    /// Column ids on the referenced (parent) side.
    pub referenced: Vec<crate::model::types::ColumnId>,
}
...
pub struct Function {
    /// Local dense id.
    pub id: crate::model::types::FunctionId,
